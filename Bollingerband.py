...
n = 20        # size of window
sigma = 2.7     # number multiplied with sigma
base_date = '2021-02-01'

dataframe = fdr.DataReader('005930', '2021')     # Index is already 'Date'
...
bollinger.plot(figsize=(16, 9), title='SAMSUNG')
plt.savefig('/workspace/AI-Trade_/plots/SAMSUNG2021.png')
